...
<head>
  ...
  <title>Home | Oudio Drop Record</title>
    ...
    <div id="home-slider" class="carousel slide carousel-fade" data-ride="carousel">
      <div class="carousel-inner">
        <div class="item active" style="background-image: url(images/slider/1.jpg)">
          <div class="caption">
            <h1 class="animated fadeInLeftBig">Welcome to <span>Oudio Drop</span></h1>
            <!--<p class="animated fadeInRightBig">Tagline</p>
            <a data-scroll class="btn btn-start animated fadeInUpBig" href="#services">Start now</a>-->
          </div>
        </div>
        <div class="item" style="background-image: url(images/slider/2.jpg)">
          <div class="caption">
            <h1 class="animated fadeInLeftBig">We Drop<span> Records</span></h1>
            <!--<p class="animated fadeInRightBig">Tagline</p>
            <a data-scroll class="btn btn-start animated fadeInUpBig" href="#services">Book now</a>-->
          </div>
        </div>
        <!--
        <div class="item" style="background-image: url(images/slider/3.jpg)">
          <div class="caption">
            <h1 class="animated fadeInLeftBig">Book <span>Artists</span></h1>
